            ...
            <div class="col-lg-5 d-flex align-items-center justify-content-center">
                <div class="w-100 px-4" style="max-width: 500px;">
                    ...
                    <div class="d-flex justify-content-end mb-3">
                        <a href="<?php echo e(route('home')); ?>" class="btn btn-light btn-sm d-flex align-items-center gap-2 text-decoration-none border border-primary text-primary" 
                    ...
                    <div class="card border-0 shadow-lg rounded-4 overflow-hidden position-relative">
                        ...
                        <div class="card-body">
                            <form action="<?php echo e(route('company.login.post')); ?>" method="POST" class="needs-validation" novalidate>
                                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="d-flex align-items-start gap-3 bg-danger bg-opacity-10 p-3 rounded-3 border border-danger border-opacity-25 mb-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="small text-muted mb-0">
                                            ...
                                            <a href="<?php echo e(route('login.applicant')); ?>" class="text-success text-decoration-none fw-semibold">Use Job Seeker Login Portal →</a>
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="text-center p-3 bg-light rounded-3 mb-4 border">
                                    ...
                                    <a href="<?php echo e(route('register.company')); ?>" class="text-decoration-none fw-semibold text-primary">
                                ...
                                <div class="row g-2">
                                    <div class="col-md-6">
                                        <a href="<?php echo e(route('login.applicant')); ?>" class="btn btn-outline-secondary text-start d-flex align-items-center gap-3 p-3 w-100">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const applicantLoginUrl = '<?php echo e(route("login.applicant")); ?>';
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\REDMI\Documents\jobmatch_finaly\resources\views/Auth/loginCompany.blade.php ENDPATH**/ ?>