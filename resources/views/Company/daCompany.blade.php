  ...
  <div class="dashboard-container">
    ...
    <main class="dashboard-content px-4 py-3">
      <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        {{-- Hanya tampilkan tombol Post New Job jika profil perusahaan sudah lengkap --}}
      ...
      <div x-data="jobCompanyApp()" 
        ...
        {{-- Pesan jika profil perusahaan belum lengkap --}}
        @if(!$companyProfileExists)
        ...
        @else {{-- Tampilkan daftar pekerjaan jika profil perusahaan sudah lengkap --}}
            <!-- Jobs Grid -->
                  ...
                  <div class="job-card">
                    <div class="card-header">
                      <div class="company-logo">
                        {{-- Pastikan path logo benar, asumsi disimpan di storage/app/public/logos --}}
                        {{-- Menambahkan cache-busting parameter '?v=' --}}
                    ...
                    <div class="card-body">
                      ...
                      {{-- Menggunakan job_description sesuai model Job --}}
        ...
        @endif {{-- End of companyProfileExists conditional --}}
